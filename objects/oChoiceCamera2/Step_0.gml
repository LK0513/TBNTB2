...
if(global.hp_current == 65 || global.hp_current == 15 || global.hp_current == 35 || global.hp_current ==85)
{
	zoom_level = 1;
	oChoice2.visible = false;
	oQuestion2.visible = false;
	//objTelZoom.visible = false;
	oAfter2.visible = true;
